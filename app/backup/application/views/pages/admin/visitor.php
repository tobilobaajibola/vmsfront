					...
					<div class="table-responsive">
							...
							<tbody>
									<?php
												...
												?>
								<tr>
									<td class="text-center"><img src="<?php echo base_url();?>assets/images/captures/<?php echo $list_visitors['capture_name'];?>" alt="" width="40"></td>
									...
									<td>
										<ul class="list-inline m-0 fs-12">
											<li><?php echo $list_visitors['lastcheckin_date']; ?></li>
											<li>(<?php echo $list_visitors['lastcheckin_time']; ?>)</li>
										</ul>
									</td>
