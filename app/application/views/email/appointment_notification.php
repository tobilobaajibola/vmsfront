                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="tbrr p30-15" style="padding: 60px 30px; border-radius:26px 26px 0px 0px;" bgcolor="#f2f2f2">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td class="h1 pb25" style="color:#811f1f; font-family:'Muli', Arial,sans-serif; font-size:40px; line-height:46px; padding-bottom:25px;">Dear <?php echo $appointment_data['firstname']?></td>
                            </tr>
                            <tr>
                              <td class="pb25" style="color:#365072; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:30px; text-align:left; padding-bottom:25px;">
                                Your appointment with <?php echo $data['employee_data']['firstname'] .''. $data['employee_data']['lastname'];?> name from @company name has been scheduled, kindly find below your access code.
                            </tr>
                            <!-- Button -->
                            <tr>
                              <td align="left">
                                <table class="left" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                  <tr>
                                    <td class="pink-button text-button" style="background:#811f1f; color:#365072; font-family:'Muli', Arial,sans-serif; font-size:14px; line-height:18px; padding:12px 30px; text-align:center; border-radius:0px 22px 22px 22px; font-weight:bold;">

                                      <p target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;">@accescode</span></p></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                ...
                <tr>
                  <td class="p30-15 bbrr" style="padding: 50px 30px; border-radius:0px 0px 26px 26px;" bgcolor="#f2f2f2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="text-footer1 pb10" style="color:#365072; font-family:'Muli', Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; padding-bottom:10px;"><?php echo $_SESSION['company_account']['company'];?></td>
                      </tr>
                      <tr>
