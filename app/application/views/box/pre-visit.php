      ...
      <div id="show_after_submit"></div>
            ...
            <!-- <form class="collapse bs-validate" novalidate method="post" action="#" id="accordionAccountSignUp" data-parent="#accordionAccount"> -->
               <form class="collapse bs-validate hide_after_submit  show" novalidate id="checkin_pre_visit" data-parent="#accordionAccount" autocomplete="off">
               ...
               <div class="col-md-12">
               <div class="form-label-group mb-3">
                  <input required id="email" type="email" class="form-control" name="email" value="" placeholder="Email">
               ...
               <!-- GDPR CONSENT -->
                     ...
                     <span class="fs--12">   
                        ...
                        <a href="#privacyaccordion" aata-toggle="collapse" aria-expanded="true"  aria-controls="privacyaccordion">Privacy Policy</a>. 
                     </span>
                  </label>
              </div>
              </div>											
		<div class="row"> 
               <div class="col-md-12" id="checkinbutton">   
