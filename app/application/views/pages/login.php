...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="wrapper">
			...
			<!-- light logo : mobile -->
			<a aria-label="go back" href="<?php echo front_asset();?>" class="position-absolute top-0 start-0 mt-3 mx-4 z-index-1 h--70 d-inline-flex align-items-center d-lg-none">
				<img src="<?php echo front_asset();?>assets/images/logo/vistack_logo.png" width="110" alt="...">
			</a>


			<!-- go back button : desktop -->
			<a href="<?php echo front_asset();?>" class="btn btn-primary rounded-circle position-absolute top-0 start-0 mx-4 my-4 z-index-1 d-none d-lg-inline-block" aria-label="go back" title="go back" data-toggle="tooltip">
				...
				<div class="col-12 col-lg-5 d-lg-flex bg-gradient-primary text-white d-none d-lg-block">
					<div class="w-100 align-self-center text-center">
						...
						<div class="d-inline-block max-w-600">
							...
							<a href="<?php echo front_asset();?>" class="text-decoration-none" data-aos="fade-in" data-aos-delay="150" data-aos-offset="0">
								<img class="w--150" src="<?php echo front_asset();?>assets/images/logo/vistack_logo.png" alt="...">
							</a>
				...
				<div class="col-12 col-lg-7 d-lg-flex">
					<div class="w-100 align-self-center text-center py-7">
						...
						<div class="max-w-600 w-100 d-inline-block text-align-start p-4">
							...
							Lobby Sign <span class="font-weight-medium">In</span> 
							</h1>
									<p class="text-danger">
						...
						<!-- 	<div class="alert bg-white shadow-xs text-dark p-3 my-2 b-0 rounded d-inline-block w-100 max-w-600">
								...
								Vistacks uses cookies for best experience! <a href="#!" class="link-muted">Learn more</a>
							</div> -->
