<div class="bg-white shadow-xs p-2 mb-4 rounded row">
						<div class="clearfix bg-light p-2 rounded d-flex align-items-center container">
							<div class="col-md-6"><a href="#!" class="js-ajax-modal bg-gradient-warning row-pill b-0 py-1 mb-0 float-start  p-2"
...
data-checkgroup-checkbox-unique="true" 
		data-checkgroup-ajax-url="<?php //echo base_url();?>admin/boxes/enable_auto_tag" 
					...
					<table class="table-datatable table table-bordered table-hover table-striped" 
						...
						<tbody>
							...
							<tr>
								...
								<td>
										<?php if($list_visitor_tags['status']==0){
											?>
										<a class="js-ajax-confirm  btn btn-sm btn-danger btn-soft b-0 px-2 py-1 m-0 fs--12 mt--n3 float-end" href="#"
											data-href="<?php echo base_url();?>admin/visitors/box_delete_visitor_tag/<?php echo $list_visitor_tags['tag_id'];?>" 
								...
								<td>
									<?php echo $list_visitor_tags['desk_in_name']; ?>
								</td>
								<td>
									<?php echo $list_visitor_tags['desk_out_name']; ?>
								</td>
