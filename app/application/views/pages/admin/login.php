			...
			<!-- light logo -->
			<a aria-label="go back" href="<?php echo base_url();?>" class="position-absolute top-0 start-0 my-2 mx-4 z-index-3 h--70 d-inline-flex align-items-center">
				<img src="<?php echo base_url();?>assets/images/logo/vistack_logo_light.png" width="110" alt="...">
			</a>
