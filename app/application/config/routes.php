...
// host details
// create appointment
$route['mapi/createappointment'] = 'api/appointments/create_appointments';
$route['mapi/listappointment'] = 'api/appointments/list_appointments';
$route['mapi/appointmentdetail/(:any)'] = 'api/appointments/appointment_detail/$1';
$route['mapi/appointmentdelete/(:any)'] = 'api/appointments/delete_appointment/$1';
$route['mapi/checkin'] = 'api/appointments/list_host_checkin/$1/$2';
$route['mapi/checkin_details/(:any)'] = 'api/appointments/host_checkin_detail/$1';
// appointment detail
// delete appointment
// edit appointment

$route['api/list_visitor'] = 'api/apis/api_list_visitors';	
$route['api/visitor_detail/(:any)/(:any)'] = 'api/apis/api_list_visitors';
$route['api/visit_history'] = 'api/apis/api_visitor_history';
$route['api/list_checkin/(:any)/(:any)'] = 'api/apis/api_list_visitors';
$route['api/checkin_details/(:any)'] = 'api/apis/api_checkin_details/$1';
$route['api/admit_visitor'] = 'api/apis/admit_visitors';
// checked in visitors
...
$route['admin/admin_setting'] = 'admin/accounts/admin_settings';
