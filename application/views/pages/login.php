      ...
      <div id="show_after_submit"></div>
            ...
            <form class="collapse bs-validate" id="login_user"  onsubmit="login_user('#login_user', '<?php echo base_url();?>accounts/login_users' );return false"   data-parent="#accordionAccount">
               <div id="show_after_submit"></div>
<!-- method="post" action="<?php //echo base_url();?>accounts/login_users" -->
            ...
            <!-- <form class="collapse bs-validate" novalidate method="post" action="#" id="accordionAccountSignUp" data-parent="#accordionAccount"> -->
               <form class="collapse bs-validate hide_after_submit  show" novalidate id="register_user"  onsubmit="form_submitter('#register_user', '<?php echo base_url();?>accounts/register_users' );return false"   data-parent="#accordionAccount">

               <h5 class="text-center pb-3">Sign Up</h5>
               <div class="form-label-group mb-3">
                  <input required id="signup_first_name" type="text" class="form-control"  name="first_name" value="" placeholder="Full Name">
                  <label for="signup_first_name">First Name</label>
               </div>
               <div class="form-label-group mb-3">
                  <input required id="signup_last_name" type="text" class="form-control"  name="last_name" value="" placeholder="Last Name">
                  <label for="signup_last_name">Last Name</label>
               </div>
               <div class="form-label-group mb-3">
                  <input required id="signup_last_name" type="text" class="form-control" name="company_name" placeholder="Company Name">
                  <label for="signup_last_name">Company Name</label>
               </div>

               <div class="form-label-group mb-3">
                  <input required id="signup_email" type="email" class="form-control" name="company_email" value="" placeholder="Email">
                  <label for="signup_email">Email</label>
               </div>
               <div class="form-label-group mb-3">
                  <input required id="signup_email" type="number" class="form-control" name="company_phone" value="" placeholder="Company Phone">
                  <label for="signup_email">Company Phone</label>
               </div>

               <div class="input-group-over">
                  
                  <div class="form-label-group mb-3">
                     <input required placeholder="Password" id="account_password" name="password" value="" type="password" class="form-control">
