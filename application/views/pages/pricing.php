				...
				<section class="bg-theme-color-light">
					...
					<div class="container min-h-50vh pt-5"> 
						...
						<div class="row text-center-xs d-middle justify-content-start">
							...
							<div class="col-12 col-md-5 order-2 order-md-1 pb-5" data-aos="fade-up" data-aos-delay="0">

								<div class="mb-5">
									
									<h1 class="h2-xs display-4 font-weight-medium mb-0">
										Create a  <span class="text-primary">Vistacks Account</span> 
									</h1>
									
									<p class="h3 h2-xs font-weight-medium mb-4">
										Bring innovation to your front desk
									</p>

									<p class="lead mb-4">
										PAY AS YOU GO
										<small class="d-block fs--12">Pay for only what you use</small>
									</p>

									<div class="mt-5">
										<a href="<?php echo base_url();?>demo" class="js-ajax btn btn-primary btn-lg transition-hover-top">
							...
							<div class="col-12 col-md-7 order-1 order-md-2 pb-5" data-aos="fade-up" data-aos-delay="200">

								<!-- svg image -->
								<img width="700" height="477" class="img-fluid" src="demo.files/svg/premium/startup.svg" alt="...">
					...
					<!-- svg shape -->
					<!--
					<svg class="position-absolute bottom-0 z-index-n1 w-100 h--200" viewBox="0 0 1920 90" preserveAspectRatio="none">
				...
				<!-- BILLING SWITCHER -->
				<section class="p-0 bg-transparent mt--n50 position-relative z-index-2">
					<div class="container">
						
						<div class="bg-white shadow-primary-xs rounded pt-4 pb-4">

							<!-- Billing Switcher -->
							<div class="d-flex justify-content-center p--15">
								<span class="text-gray-600">Monthly</span>

								<label class="form-switch form-switch-pill form-switch-primary m-0 mx-3">
						...
						<!-- mobile swipe info -->
						<div class="d-block d-sm-none position-relative bg-theme-color-light clearfix text-center p-4 mt-3 text-gray-500">
							<i class="fi fi-arrow-left-slim float-start"></i>
							<i class="fi fi-arrow-right-slim float-end"></i>
							<span class="text-gray-500">
								swipe table below left/right
							</span>
				...
				<section>
					<div class="container">
						...
						<div class="table-responsive">
							...
							<table class="table table-hover table-align-middle font-weight-medium text-center">

								<thead>
									<tr>
										<th class="text-align-start text-muted fs--13">
											<span class="d-block pt-5">
												* VAT exclusive
											</span>
										</th>
										<th class="font-weight-medium text-center text-primary fs--20 w--180">
											<span class="d-block w--180 fs--17">PAY AS YOU GO</span>
											
											<div class="h3 d-block text-muted font-weight-light mt-2">
												<span class="fs--16">N</span> 
												...
												<span class="pricetable-count"
													...
													data-count-toggle='[
														{"from":"0", "to":"30000", "duration":800},
														{"from":"30000", "to":"30000", "duration":800}
													]'
												>39</span>

												<span class="fs--16 font-weight-light">One Off</span>
											</div>

										</th>
										<th class="font-weight-medium text-center text-primary fs--20 w--180">
											<span class="d-block w--180 fs--17">ESSENTIAL</span>
										...
										<th class="font-weight-medium text-center text-primary fs--20 w--180">
											<span class="d-block w--180 fs--17">COMPACT</span>
											...
											<div class="h3 d-block text-muted font-weight-light mt-2">
												...
												<span class="pricetable-count"
													...
													data-count-toggle='[
														{"from":"0", "to":"45000", "duration":800},
														{"from":"45000", "to":"45000", "duration":800}
													]'
												>39</span>

												<span class="fs--16 font-weight-light">/90 days</span>
											</div>

										</th>

										<th class="font-weight-medium text-center text-primary fs--20 w--180">
											<span class="d-block w--180 fs--17">PREMIUM</span> 
											...
											<div class="h3 d-block text-muted font-weight-light mt-2">
												...
												<span class="pricetable-count"
													...
													data-count-toggle='[
														{"from":"0", "to":"60000", "duration":800},
														{"from":"60000", "to":"60000", "duration":800}
													]'
												>39</span>

												<span class="fs--16 font-weight-light">/365 days</span>
											</div>
								...
								<tbody>
									<tr class="font-weight-normal">
										<td class="text-align-start">Visitor Checkin</td>
										
										<td>1000</td>
										<td class="bg-theme-color-light">Unlimited</td>
										<td>Unlimited</td>
										<td>Unlimited</td>
									</tr>
									<tr class="font-weight-normal">
										<td class="text-align-start">Touchless Checkin</td>
										<td>Available</td>
										<td class="bg-theme-color-light">Available</td>
										<td>Available</td>
										<td>Available</td>
									</tr>
									<tr class="font-weight-normal">
										<td class="text-align-start">
											...
											<small class="d-block text-muted">Able to select roles for each account.</small>
										</td>
										<td>Available</td>
										<td class="bg-theme-color-light">Available</td>
										<td>Available</td>
									...
									<tr class="font-weight-normal">
										<td class="text-align-start">Realtime Data</td>
										<td>Unlimited</td>
										<td class="bg-theme-color-light">Unlimited</td>
										<td>Unlimited</td>
										<td>Unlimited</td>
									...
									<tr class="font-weight-normal">
										<td class="text-align-start">Support</td>
										<td>Standard</td>
										<td class="bg-theme-color-light">Standard</td>
										<td>Premium</td>
										<td>Premium</td>
									</tr>
									<tr class="font-weight-normal">
										<td class="text-align-start text-primary">
											One time Set up fee
											<small class="d-block text-muted">Easy account setup.</small>
										</td>
										<td>N100,000</td>
										<td class="bg-theme-color-light">N100,000</td>
										<td>N100,000</td>
										<td>N100,000</td>
									</tr>
									<tr class="font-weight-normal">
									...
									<?php 
										foreach ($list_subscription as $list_subscriptions) {
											?>
											<form class="collapse bs-validate show" novalidate  onsubmit="form_submitter('#addtocart<?php echo  $list_subscriptions['category_id'];?>', '<?php echo base_url();?>carts/addtocart' );return false" id="addtocart<?php echo  $list_subscriptions['category_id'];?>" data-parent="#accordionDropdownSignInUp">
											<input type="hidden" name="category_id" value="<?php echo  $list_subscriptions['category_id'];?>">
											<td>
												<!-- js-ajax btn btn-primary btn-lg transition-hover-top -->
											<button type="submit" class="btn btn-primary btn-soft btn-block ">
												Buy now <i class="fi fi-layers"></i>
											</button>
											</td>
										</form>
										<?php
									...
									<tr class="font-weight-normal">
										...
										<td>&nbsp;</td>
										<td class="bg-theme-color-light text-gray-500 font-weight-normal fs--13 alert_success">
											RECOMMENDED
										</td>
									...
									<tr class="bg-transparent">
										<td class="text-align-start bt-0 pt--120 fs--20 font-weight-light"><span class="font-weight-medium">PREMIUM</span> FEATURES</td>
										<td class="pt--60 bt-0">&nbsp;</td>
										<td class="bpt--60 bt-0">&nbsp;</td>
										<td class="pt--60 bt-0">&nbsp;</td>
									</tr>
									<tr>
										<td class="text-align-start">
											Modular Design
											<small class="d-block text-muted">Effortlessly use/create/modify multiple included layouts</small>
										</td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
									</tr>
									<tr>
										<td class="text-align-start">
											...
											<small class="d-block text-muted">
												Realtime data. Sort, search &amp; filter data
											</small>
										</td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-check fs--25 text-primary"></i></td>
									...
									<tr>
										<td class="text-align-start">
											...
											<small class="d-block text-muted">
												Preregister visitors from admin
											</small>
										</td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-check fs--25 text-primary"></i></td>
									...
									<tr>
										<td class="text-align-start">
											Speedy repeat visitor process
											<small class="d-block text-muted">Allows fast checkin for visitors who have previously visited</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
									</tr>
									...
									<tr>
										<td class="text-align-start">
											Integrate Company Ads Banner
											<small class="d-block text-muted">Let visitors know about your company</small>
											<small class="d-block text-muted">Display you latest products and have them interact with it</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-check fs--25 text-primary"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
									...
									<tr>
										<td class="text-align-start">
											Check visitors out remotely
											<small class="d-block text-muted">Clear checkin logs my remotely checking out visitors</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
									</tr>
									<tr>
										<td class="text-align-start">
											Visitor Watchlist
											<small class="d-block text-muted">
												Blacklist visitors that are found wanting
											</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-close fs--25 text-danger"></i></td>
									...
									<tr>
										<td class="text-align-start">
											...
											<small class="d-block text-muted">Individual &amp; bulk messages between staff members</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
									...
									<tr>
										<td class="text-align-start">
											...
											<small class="d-block text-muted">Various realtime notifications for admins</small>
										</td>
										<td><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td class="bg-theme-color-light"><i class="fi mdi-close fs--25 text-danger"></i></td>
										<td><i class="fi mdi-check fs--25 text-primary"></i></td>
				...
				<section class="bg-theme-color-light">
					<div class="container" data-aos="fade-in" data-aos-delay="100">
						...
						<div class="text-center mb--80">
							<span class="badge badge-primary badge-soft badge-pill pl-2 pr-2 pt--6 pb--6">
								F &bull; A &bull; Q
							</span>
						...
						<div class="row">
							...
							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">Can i customize to reflect my company's brand?</h3>
								<p>
									Yes! It parts of the set up and integration process. We understand its a generic application but we try as much as possible to give your visitors the experience that reflects your brand.
								</p>
							</div>

							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">Is this replacing receptionist?</h3>
								<p>
									Our core value is "<b>let's fight together for the better</b>". Would make no sense to limit your freedom, isn't it? If you want to leave to other platform, you can export: products, orders, users and subscribers. You own your data!
								</p>
							</div>

							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">Do I have a traffic limit?</h3>
								<p>
									No, there is no such thing like "traffic limit" or "checkin limit".
								</p>
							</div>

							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">Can I upgrade my plan later?</h3>
								<p>
									Sure! You can upgrade or downgrade your plan. Higher plans comes with more attractive discounts.
								</p>
							</div>

							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">What happens if prices goes up?</h3>
								<p>
							...
							<div class="col-12 col-sm-6 mb-4">
								<h3 class="fs--18">Can I transfer/sell my account?</h3>
								<p>
						...
						<p class="fs--14">
							Please feel free to visit our <a href="help-center-1-index.html">Help Center 1</a> for more. <br>
							* VAT Exclusive.
						</p>
				...
				<section class="bg-gradient-default text-white">
					...
					<!-- svg shape -->
					<svg class="position-absolute top-0 start-0 end-0" viewBox="0 480.469 1000 39.062">
						<polygon fill="#f7f9ff" points="0,519.531 0,480.469 1000,480.469 "></polygon>
					</svg>
					...
					<div class="container text-center mt-7 mb-5">
						...
						<div class="text-center mb-6 pt-5">
							...
							<div class="mx-auto max-w-600">
								...
								<p class="lead">
									Curious about how Vistacks can improve your business? 
						...
						<a href="<?php echo base_url();?>demo" class="js-ajax btn btn-purple rounded-xl transition-hover-top">
							Request a Demo
						</a>
