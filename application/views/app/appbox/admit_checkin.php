					...
					<div class="row">
						<div class="col-sm-8 offset-sm-2">
							...
							<div class="alert alert-light b-0">
								...
								<p class="text-center">
							<a class="lightbox" href="<?php echo base_url();?>assets/images/captures/<?php echo $visitor_tag_data['capture_name'];?>" data-lightbox="iframe" data-plugin-options='{"type":"iframe"}'>View visitor image</a></p>
								<hr>
