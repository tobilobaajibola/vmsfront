                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <h2 >Hey, <?php echo $register_data['first_name'];?>,</h2>
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                               ...
                               <p>We at padimi.co would lie to welcome you. thanking for taking the first step to a bold begining, kindly click on the subscribe botton to get our newsletters and join our mailing list. It's also the easiest way to stay updated on trends in and around the healthcare, insurance, and finance space.</p>
                               <p> We look forward to a brighter future together with you by our side.</p>
                                <p>Best regards </p>
                                <p>Seth Usanga,</p>
                                <em>Founder Padimi.co</em>
                              </div>
                              </div>
                            </td>
                          </tr>
                              ...
                              <table>
                                <tr>
                                  <td align='center' bgcolor='#1A54BA' style='background:#DC2828; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                    <div class="contentEditableContainer contentTextEditable">
                                      <div class="contentEditable" align='center'>
                                        <a target='_blank' href='<?php echo base_url();?>account/emailvalidate/<?php echo $email_validation_data['validation_key'];?>' class='link2' style='color:#ffffff;'>Activate your Account</a>
                                      </div>
                                    </div>
                                  </td>
                                </tr>
